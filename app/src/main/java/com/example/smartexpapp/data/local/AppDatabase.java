...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static final Migration MIGRATION_1_2 = new Migration(1, 2) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            // Schema is unchanged; this keeps existing installs on a monotonic Room
            // version.
        }
    };
    ...
    public static final Migration MIGRATION_5_6 = new Migration(5, 6) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL(
                    "CREATE TABLE IF NOT EXISTS `categories` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `sort_order` INTEGER NOT NULL, `is_built_in` INTEGER NOT NULL, `active` INTEGER NOT NULL, `owner_user_id` TEXT, `cloud_id` TEXT, `sync_status` TEXT NOT NULL, `last_synced_at` INTEGER, `created_at` INTEGER NOT NULL, `updated_at` INTEGER NOT NULL, `deleted_at` INTEGER, PRIMARY KEY(`id`))");
            database.execSQL(
                    "CREATE UNIQUE INDEX IF NOT EXISTS `index_categories_owner_user_id_name` ON `categories` (`owner_user_id`, `name`)");
    ...
    public static final Migration MIGRATION_6_7 = new Migration(6, 7) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL(
                    "ALTER TABLE user_settings ADD COLUMN reminder_notify_time_minutes INTEGER NOT NULL DEFAULT 540");
        }
    };
    public static final Migration MIGRATION_7_8 = new Migration(7, 8) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE user_settings ADD COLUMN profile_avatar_path TEXT");
        }
    };

...
public final class LocalDataContract {
    ...
    public static final String STORAGE_FREEZE_NAME = "Freeze";

    private LocalDataContract() {
    }

    public static String storageIdForName(String storageName) {
        if (STORAGE_REFRIGERATOR_NAME.equals(storageName)) {
            return STORAGE_REFRIGERATOR_ID;
        }
        if (STORAGE_FREEZE_NAME.equals(storageName) || "Freezer".equals(storageName)) {

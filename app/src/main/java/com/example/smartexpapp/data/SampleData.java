...
public final class SampleData {
    ...
    public static List<SettingItem> settings(Context context) {
        return Arrays.asList(
                ...
                new SettingItem(SettingItem.KEY_EXPIRING_SOON, context.getString(R.string.settings_expiring_soon_title), context.getString(R.string.settings_expiring_soon_desc), R.drawable.ic_notification_bell, false),
